...
class Deformation(nn.Module):
    ...
    def forward(self, rays_pts_emb, scales_emb=None, rotations_emb=None, opacity=None, shs_emb=None, time_feature=None,
                time_emb=None):
        if time_emb is None:
            return self.forward_static(rays_pts_emb[:, :3])
        else:
            return self.forward_dynamic(rays_pts_emb, scales_emb, rotations_emb, opacity, shs_emb, time_feature,
                                        time_emb)
...
class deform_network(nn.Module):
    ...
    def forward_dynamic(self, point, scales=None, rotations=None, opacity=None, shs=None, times_sel=None):
        ...
        means3D, scales, rotations, opacity, shs, dx, dshs = self.deformation_net(point_emb,
                                                                                  scales_emb,
                                                                                  rotations_emb,
                                                                                  opacity,
                                                                                  shs,
